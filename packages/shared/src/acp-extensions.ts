 ...
 *
 * Lives in @posthog/shared (not @posthog/agent) because the renderer needs
 * these constants. The agent source tree transitively pulls in `node:fs`,
 * which Vite externalizes and which crashes the browser bundle on access.
 */
