...
export const NEST_OBSTACLE_RADIUS = HEDGEMONY_CONFIG.radii.nest;
...
export const HEDGEHOUSE_OBSTACLE_RADIUS = HEDGEMONY_CONFIG.radii.hedgehouse;
...
export const HOGLET_RADIUS = HEDGEMONY_CONFIG.radii.hoglet;
...
export const BUILDER_OBSTACLE_RADIUS = HEDGEMONY_CONFIG.radii.builder;
