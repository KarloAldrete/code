...
export const contextMenuRouter = router({
  ...
  showChatContextMenu: publicProcedure
    .input(chatContextMenuInput)
    .output(chatContextMenuOutput)
    .mutation(({ input }) => getService().showChatContextMenu(input)),
