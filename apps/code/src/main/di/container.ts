...
import { BridgeRepository } from "../db/repositories/bridge-repository";
import { BuilderStateRepository } from "../db/repositories/builder-state-repository";
import { FeedbackEventRepository } from "../db/repositories/feedback-event-repository";
import { HedgehogStateRepository } from "../db/repositories/hedgehog-state-repository";
...
import { OverlapRepository } from "../db/repositories/overlap-repository";
...
import { BuilderTickService } from "../services/hedgemony/builder-tick-service";
import { CloudTaskClient } from "../services/hedgemony/cloud-task-client";
import { FederationService } from "../services/hedgemony/federation-service";
import { FeedbackRoutingService } from "../services/hedgemony/feedback-routing-service";
import { GoalSpecDraftService } from "../services/hedgemony/goal-spec-draft-service";
import { HedgehogTickService } from "../services/hedgemony/hedgehog-tick-service";
...
container.bind(MAIN_TOKENS.BuilderStateRepository).to(BuilderStateRepository);
container.bind(MAIN_TOKENS.OverlapRepository).to(OverlapRepository);
container.bind(MAIN_TOKENS.ProposalRepository).to(ProposalRepository);
container.bind(MAIN_TOKENS.BridgeRepository).to(BridgeRepository);
...
container.bind(MAIN_TOKENS.BuilderTickService).to(BuilderTickService);
container.bind(MAIN_TOKENS.FederationService).to(FederationService);
